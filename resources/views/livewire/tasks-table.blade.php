                ...
                <div class="relative px-4 py-10 mx-0 shadow rounded-3xl sm:p-10">
                    ...
                    <div class="divide-y divide-gray-200">
                        ...
                        <div class="md:flex md:items-center md:justify-between">
                            ...
                            <div class="flex flex-col">
                            <label class="leading-loose">Deadline</label>
                            <input wire:model="deadline" type="date" id="deadline" name="deadline" class="px-4 py-2 border focus:ring-gray-500 focus:border-gray-900 w-full sm:text-sm border-gray-300 rounded-md focus:outline-none text-gray-600" placeholder="deadline" required>
